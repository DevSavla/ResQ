...
//    //Serial.print("Accelerometer = ");Serial.print(AcX); Serial.print(", ");Serial.print(AcY);Serial.print(", ");Serial.println(AcZ);
//  }
//  //delay (200);
//
//  //Gyroscope values 
...
//    //Serial.print("Gyroscope = ");Serial.print(GyX); Serial.print(", ");Serial.print(GyY);Serial.print(", ");Serial.println(GyZ);
//  }
// }
